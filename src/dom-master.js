...
import { attr, rmAttr, style, hasAttr } from './workers/attributes.js';
...
const domMaster = (Element_or_selector_or_Tag_or_Window_or_Document) => {
    ...
    return {
        ...externalMethods(domMaster.extends, allEl),
        ...
        removeAttribute(attrName){
            return domMaster(allEl.map(el => rmAttr(el, attrName)));
        },
        ...
        hasAttribute(attrName){
            return hasAttr(allEl[0], attrName)
        },
